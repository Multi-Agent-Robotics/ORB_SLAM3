...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        int SearchByHamming(const std::vector<MapPoint*> &map_points_1, const std::vector<MapPoint*> &map_points_2, std::vector<MapPoint*> &map_points_out_1, std::vector<MapPoint*> &map_points_out_2, const std::uint8_t hamming_threshold);
